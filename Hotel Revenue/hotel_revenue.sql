...
SELECT country, hotel, customer_type, stays_in_week_nights, stays_in_weekend_nights, SUM((stays_in_week_nights + stays_in_weekend_nights) * adr) AS total_revenue
FROM practice..hotel_revenue
GROUP BY country, hotel, customer_type, stays_in_week_nights, stays_in_weekend_nights
HAVING SUM((stays_in_week_nights + stays_in_weekend_nights) * adr) >= 50000
...
SELECT country, hotel, customer_type, market_segment, SUM((stays_in_week_nights + stays_in_weekend_nights) * adr) AS total_revenue
FROM practice..hotel_revenue
